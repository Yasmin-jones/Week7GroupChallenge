...
describe '.all' do
  it 'returns listings data' do
    ...
    connection.exec("INSERT INTO app_table_test (description, location, start_date, end_date, price)
    VALUES ('Beach House', 'Miami', '25-07-2022', '30-07-2022', '1000');")
    connection.exec("INSERT INTO app_table_test (description, location, start_date, end_date, price)
    VALUES ('River House', 'Wales', '27-07-2022', '31-07-2022', '1000');")
    connection.exec("INSERT INTO app_table_test (description, location, start_date, end_date, price)
    VALUES ('Lake House', 'Chesire', '01-07-2022', '06-07-2022', '1000');")
